        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          <div>
            ...
            <p className="text-white/70 max-w-md">
              AI-driven quality engineering that accelerates releases while reducing regression risk. Trusted by enterprise teams worldwide.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            <div className="space-x-6">
              ...
              <a href="#ai-testing" className="text-white/80 hover:text-white transition-colors">
                AI Testing
              </a>
              <a href="#performance-qa" className="text-white/80 hover:text-white transition-colors">
                Performance
              </a>
